...
long bitAnd(long, long);
long test_bitAnd(long, long);
long minusOne();
long test_minusOne();
long negate(long);
long test_negate(long);
long bitXor(long, long);
long test_bitXor(long, long);
long isPositive(long);
long test_isPositive(long);
